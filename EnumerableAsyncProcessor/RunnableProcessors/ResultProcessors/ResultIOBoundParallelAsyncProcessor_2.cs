...
/// <summary>
/// A specialized parallel result processor optimized for I/O-bound operations with input items.
...
/// </summary>
public class ResultIOBoundParallelAsyncProcessor<TInput, TOutput> : ResultAbstractAsyncProcessor<TInput, TOutput>
{
